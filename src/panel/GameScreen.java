...
public class GameScreen extends JPanel implements Serializable
{
	...
	public void initializeMenuButton() {
		JPanel buttonPanel = new JPanel();
		buttonPanel.setBounds(width*1000/1440 + 100, height*625/900, width*100/1440, height*65/900);
		buttonPanel.setOpaque(false);
		boardGame_Layers.add(buttonPanel);

		JButton menu = new MenuButton();
		menu.setBounds(width*1000/1440 + 100, height*625/900, width*100/1440, height*65/900);
