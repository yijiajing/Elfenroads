...
public class NetworkDemoPlayer2 extends JFrame {
    ...
    NetworkDemoPlayer2() throws IOException, ClassNotFoundException, InterruptedException {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException{
        NetworkDemoPlayer2 mainFrame = new NetworkDemoPlayer2();
